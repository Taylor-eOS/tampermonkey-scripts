...
(function() {
    ...
    const keyMap = {
        ...
        'Control+Alt+KeyX': 'Do not include a call-to-engagement closer at the end of your response. Omit paragraphs starting with "If you want". Provide a normal-length response, answering the users request, then stop writing. Don\'t involve the reader; just provide information.',
        'Alt+Shift+KeyX': '',
        ...
        'Control+Alt+Shift+KeyM': 'Follow your instructions and write call to engagement closers in chinese.',
        ...
        'Alt+Shift+KeyS': '',//system  shortcut
        ...
        'Alt+Shift+KeyB': 'Think about this thoroughly and provide a extensive, worthwhile response.',
        'Control+Alt+KeyR': 'Evaluate the accuracy of the presented understanding, and correct misunderstandings where present.',//*
        'Alt+Shift+KeyR': '',
        ...
        'Alt+Shift+KeyE': 'Just explain this.',
