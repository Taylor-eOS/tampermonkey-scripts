...
(function() {
    ...
    const keyMap = {
        ...
        'Control+Alt+Shift+Comma': 'Entirely omit any informationally worthless filler material, like commenting that everything the user says is "profound", "on point", "cutting through", "right to ask", or such. Never start any response with "You are right". Just provide content like an article: practical information without a wild sycophancy circus.',
        ...
        'Alt+Shift+KeyH': 'Add information that wasn\'t specifically requested, but which might be interesting.',
