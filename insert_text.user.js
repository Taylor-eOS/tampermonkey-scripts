...
(function() {
    'use strict';
    const keyMap = {
        'Control+Alt+Period': 'Write continuously. Write normal text without formatting, like a book. Don\'t make every sentence a new line.',
        'Alt+Shift+Period': 'Write unsegmented and without formatting, without lists or tables. Omit distracting headers, dividers, lines, etc.',
        'Control+Alt+Shift+Period': 'I wasn\'t kidding about writing continuously. Stringently eschew creating any form of list, whether numbered, bulleted, or otherwise. Write connected, unfragmented text. Do not include any list-producing tags like `<ul>`, `<ol>`, or `<li>` in your response at all. Write in continuous prose, omitting all structured separations or markup. Provide the response as one unbroken block of text. Keep sentences connected, with no structural separations or divisions. Do not organize the response into any type of enumeration. Purely write unformatted normal text without special characters like arrows. Aggressively avoid segmenting content; keep everything unified in a continuous block of prose like a book.',

        'Control+Alt+Comma': 'Target an answer to this specific question in continuous text.',
        'Alt+Shift+Comma': 'Don\'t write code yet.',
        'Control+Alt+Shift+Comma': 'Maintain interoperability with existing code by not making unnecessary name changes to identifiers.',

        'Control+Alt+KeyC': 'Do not put needless empty lines or comments all over the code.',
        'Alt+Shift+KeyC': 'Write code without comments or empty lines inside functions, or I can\'t see where functions start and end. Just place an empty line between functions.',
        ...
        'Control+Alt+Shift+KeyV': 'I don\'t need to become an expert in the intricacies of these mechanics, I just want to get it to work. Give me specific steps, not long-winded explanations.',
        ...
        'Control+Alt+Shift+KeyJ': 'Take the initiative to implement appropriate design decisions.',
        ...
        'Alt+Shift+KeyZ': 'Just say something new or interesting instead of this gruel of boring conformity.',
        'Control+Alt+Shift+KeyZ': 'Revert back to usual chat mode. Answer this prompt as a standard response, discontinuing the requested writing mode of recent prompts.',
        ...
        'Alt+Shift+KeyQ': 'Do not make assumptions about details that you weren\'t shown. The parts of the code that seemed relevant were provided. If other parts of are needed to make an informed response, ask for them instead of reinventing unseen aspects.',
        ...
        'Control+Alt+KeyK': 'Contemplate what to do about this.',
        'Alt+Shift+KeyK': 'Context start]\n```\n```\n[Context end',
        'Control+Alt+Shift+KeyK': 'Can you fact-check this.',
