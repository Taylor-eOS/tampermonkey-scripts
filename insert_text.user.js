...
(function() {
    ...
    const keyMap = {
        ...
        'Alt+Shift+Period': 'Write without lists or tables. Avoid distracting headers, dividers, lines, etc. Write unsegmented.',
        ...
        'Alt+Shift+KeyV': 'I don\'t want to become an expert in the intricacies of this, I just want to get it to work.',
        ...
        'Control+Alt+Shift+KeyW': 'Give me whole functions, not mystery snippets I don\'t know where to place. You can create new helper functions, but they need to be called from existing functions.',
        ...
        'Control+Alt+Shift+KeyI': 'Implement a this solution in the way that would be the most technically feasible, and the least prone to cause bugs and oversights.',
        ...
        'Control+Alt+KeyQ': 'I have provided the functions that I thought were relevant. If you need to see more code, ask for them instead of reinventing unseen parts. Do not make assumptions about details that you weren\'t shown.',
        ...
        'Control+Alt+KeyT': 'If the two expressions before and after an \"or\" or an \"and\" mean about the same, then combine them like a human writer would.',//system  shortcut
