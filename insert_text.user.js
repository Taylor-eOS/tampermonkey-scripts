...
(function() {
    ...
    const keyMap = {
        ...
        'Control+Alt+Shift+Period': 'Avoid all list creation, whether numbered or bulleted. No list-producing HTML tags (<ul>, <ol>, <li>) will be included. The response entirely eschews structured separations or markup, and maintains unbroken text in continuous prose without segmentation.',
        ...
        'Alt+Shift+KeyC': 'Complete code; excluding commentary, inline comments, or empty lines in functions.',
        ...
        'Control+Alt+KeyJ': 'Just give me the functions that needed to be changed.',
        ...
        'Alt+Shift+KeyA': 'Provide definitive conclusions based on actual analysis of the available code, instead of guessing about it.',
    ...
    //Simulate responding like a person who is not sure of the issue but tries to weigh the different sides of the issue.
