...
(function() {
    ...
    const keyMap = {
        'Control+Shift+Equal': '```\n```',
        'Control+Alt+Period': '[Format your response in one continuous, concise paragraph without lists.]',
        ...
        'Control+Alt+KeyN': '[Include natural language explanations, but no inline comments or empty lines in code blocks.]',
        ...
        'Control+Alt+KeyC': '[Give me the complete code, without further commentary, empty lines, inline comments, or an explanation.]',
        ...
        'Alt+Shift+KeyP': '[Write up the relevant parts of the script as pseudocode that summarizes the mechanics in high-level steps rather than focusing on implementation details, so I can understand the structural logic and find conceptual flaws.]',
        ...
        'Control+Alt+KeyU': '[Take my argument into account and update your response to incorporate it.]',
        ...
        'Control+Alt+KeyE': '[Explore, explain, elaborate.]',
        'Alt+Shift+KeyS': '[Shed some light on the unknowns I am expressing.]',
