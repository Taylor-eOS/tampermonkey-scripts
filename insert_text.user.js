...
(function() {
    'use strict';
    const keyMap = {
        'Control+Alt+Period': 'Format your response in one continuous and concise paragraph without structural list-making.',
        ...
        'Control+Alt+KeyG': 'Write code compatible with unseen project parts, using existing functions as in the provided code without reinventing unseen components. Modifications or additions will be limited to the provided snippet.',
        ...
        'Alt+Shift+KeyX': 'You do not **have** to make all responses numbered lists. Continuous prose is a perfectly fine way to communicate.',
        ...
        'Alt+Shift+KeyR': 'Present this position as a intellectual Turing test, meaning the requested stance is presented indistinguishable from someone who sincerely holds that view, without inserting caveats to the contrary.',
    ...
    //Write uninterrupted continuous prose.
    //Can you simulate responding like parson who is not sure of the issue but tries to weigh the different sides of the issue.
    //Analyze the feasibility of this idea in continuous natural language, without writing code.
