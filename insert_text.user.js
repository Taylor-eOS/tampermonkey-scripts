...
(function() {
    ...
    const keyMap = {
        ...
        'Alt+Shift+KeyI': 'interpret the prompt as an incomplete attept to phrase a consideration, and respond to the broader issue this attempts to convey, rather than to just focus on the specific aspects that were expressed.]',
