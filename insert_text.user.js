...
(function() {
    ...
    const keyMap = {
        'Control+Shift+Equal': '```\n```',
        'Control+Alt+Period': '[The following will be formatted in one continuous and concise paragraph, avoiding lists unless necessary for actual content that is items.]',
