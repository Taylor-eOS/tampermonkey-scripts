...
(function() {
    ...
    const keyMap = {
        ...
        'Alt+Shift+Period': 'Write without lists or tables. Write unsegmented and without formatting. Omit distracting headers, dividers, lines, etc. ',
        ...
        'Control+Alt+Shift+Comma': 'Maintain interoperability with existing code. Don\'t make unnecessary name changes to function names.',
        ...
        'Control+Alt+Shift+KeyV': 'I don\'t need to become an expert in the intricacies of these mechanics, I just want to get it to work.',
        ...
        'Control+Alt+Shift+KeyW': 'Write whole functions, not mystery snippets I don\'t know where to place. If you create new helper functions they need to be called from existing functions.',
        ...
        'Control+Alt+KeyX': 'Do not use overly difficult wording. Present information in a simple english that is easy to read. That does not mean simplifying it to the point of childishness; write in a normal, adult language.',
        ...
        'Control+Alt+KeyZ': 'Revert back to usual chat mode. Answer this prompt as a normal response, discontinuing the special writing mode of recent prompts.',
        'Alt+Shift+KeyZ': 'Provide useful ideas the user hadn\'t thought of instead of just paraphrasing.',
        'Control+Alt+Shift+KeyZ': '',
        'Control+Alt+KeyQ': 'These are the functions that seemed relevant. If you need to see more code, ask for it instead of reinventing unseen parts. Do not make assumptions about details that you weren\'t shown.',
        'Alt+Shift+KeyQ': 'Question unclear or lacking details in a process of clarification before providing a solution, instead of proceeding with incomplete information.',
        'Control+Alt+Shift+KeyQ': '',
        'Control+Alt+KeyK': '',
        ...
        'Alt+Shift+KeyP': 'Fact-check this.',
